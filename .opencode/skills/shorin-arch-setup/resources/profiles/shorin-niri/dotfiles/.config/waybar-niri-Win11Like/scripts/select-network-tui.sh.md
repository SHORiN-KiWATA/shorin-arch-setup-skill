---
source: dotfiles/.config/waybar-niri-Win11Like/scripts/select-network-tui.sh
target: .config/waybar-niri-Win11Like/scripts/select-network-tui.sh
type: text
language: bash
mode: "0755"
executable: true
...
owner_scope: user
backup: true
sha256: "7d39b844cbef4a4e11e53f50edef9a643960b4d65aa58b1491571ef1cb4f1fa7"
size_bytes: 3109
git_status: clean
---

# .config/waybar-niri-Win11Like/scripts/select-network-tui.sh

Source: `dotfiles/.config/waybar-niri-Win11Like/scripts/select-network-tui.sh`

Install target: `~/.config/waybar-niri-Win11Like/scripts/select-network-tui.sh`
