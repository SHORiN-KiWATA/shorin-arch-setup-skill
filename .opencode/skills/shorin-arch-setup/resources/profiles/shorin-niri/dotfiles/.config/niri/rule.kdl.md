---
source: dotfiles/.config/niri/rule.kdl
target: .config/niri/rule.kdl
type: text
language: kdl
mode: "0644"
executable: false
...
owner_scope: user
backup: true
sha256: "3e7b6b34df9cd1840d3e5cb4e64028d887718da05ce481245500898768a60ebd"
size_bytes: 6239
git_status: M
---

# .config/niri/rule.kdl

Source: `dotfiles/.config/niri/rule.kdl`

Install target: `~/.config/niri/rule.kdl`
...
// bilibili webapp 的窗口规则，以标签页模式打开
window-rule{
	match app-id="WebApp-bilibili8002"
...
window-rule {
    ...
    match app-id="io.github.fabrialberio.pinapp"
    match app-id="org.gnome.Calculator"
    match app-id="floating-mpv"
    match app-id="thunar"
    open-floating true
}
// 开启后不聚焦的窗口
...
window-rule {
    ...
    match app-id="wechat"
    match app-id="^WebApp-GeminiAiStudio1566$"
