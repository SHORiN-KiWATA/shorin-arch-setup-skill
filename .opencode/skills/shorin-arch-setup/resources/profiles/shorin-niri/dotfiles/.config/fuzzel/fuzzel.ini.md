...
owner_scope: user
backup: true
sha256: "6d7a129ae64fc8f5c1f48555945ded5eb3e0946b587345ee60fb4f4e5a01b7d8"
size_bytes: 2910
git_status: clean
---
...
Install target: `~/.config/fuzzel/fuzzel.ini`
...
launch-prefix=sh -c 'exec ~/.config/fuzzel/scripts/fuzzel-web-search "$@"' --
# anchor=center
# x-margin=0
# y-margin=0
 lines=9
