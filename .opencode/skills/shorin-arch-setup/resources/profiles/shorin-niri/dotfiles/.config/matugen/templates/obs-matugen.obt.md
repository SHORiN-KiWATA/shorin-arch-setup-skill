---
source: dotfiles/.config/matugen/templates/obs-matugen.obt
target: .config/matugen/templates/obs-matugen.obt
type: text
language: text
mode: "0644"
executable: false
...
owner_scope: user
backup: true
sha256: "61a09f2f6513acad1692916b8703cedbaf258e79115f226708c7cb3b9d48b201"
size_bytes: 58067
git_status: clean
---

# .config/matugen/templates/obs-matugen.obt

Source: `dotfiles/.config/matugen/templates/obs-matugen.obt`

Install target: `~/.config/matugen/templates/obs-matugen.obt`
...
QListWidget::item:selected {
    background-color: var(--primary);
    border-color: var(--primary_light);
    color: var(--black2); /* 新增：让选中时的文字变成深黑色 */
}
...
QListWidget::item:selected:hover {
    ...
    color: var(--black2); /* 修改：把原来的 var(--text) 改为深色 */
}
...
QGroupBox::indicator:checked {
    background-color: var(--primary);
    border-color: var(--primary_light);
    image: url(theme:Dark/check.svg); /* 使用 OBS 自带的勾选图标 */
}
...
.checkbox-icon::indicator:checked,
.checkbox-icon::indicator:unchecked,
.checkbox-icon::indicator:hover {
    background-color: transparent;
    border: none;
}
...
idian--Row idian--CheckBox::indicator:checked {
    background-color: var(--primary);
    border-color: var(--primary_light);
    image: url(theme:Dark/check.svg);
}
