---
source: dotfiles/.config/waybar/scripts/check-updates.sh
target: .config/waybar/scripts/check-updates.sh
type: text
language: bash
mode: "0755"
executable: true
...
Install target: `~/.config/waybar/scripts/check-updates.sh`
