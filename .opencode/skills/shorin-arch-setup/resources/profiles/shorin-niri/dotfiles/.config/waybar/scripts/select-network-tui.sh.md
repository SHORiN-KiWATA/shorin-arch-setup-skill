---
source: dotfiles/.config/waybar/scripts/select-network-tui.sh
target: .config/waybar/scripts/select-network-tui.sh
type: text
language: bash
mode: "0755"
executable: true
...
# .config/waybar/scripts/select-network-tui.sh

Source: `dotfiles/.config/waybar/scripts/select-network-tui.sh`

Install target: `~/.config/waybar/scripts/select-network-tui.sh`
