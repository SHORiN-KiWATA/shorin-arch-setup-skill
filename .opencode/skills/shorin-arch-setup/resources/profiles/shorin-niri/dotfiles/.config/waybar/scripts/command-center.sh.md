---
source: dotfiles/.config/waybar/scripts/command-center.sh
target: .config/waybar/scripts/command-center.sh
type: text
language: bash
mode: "0755"
executable: true
...
# .config/waybar/scripts/command-center.sh

Source: `dotfiles/.config/waybar/scripts/command-center.sh`

Install target: `~/.config/waybar/scripts/command-center.sh`
