...
owner_scope: user
backup: true
sha256: "40d2e9ed72f22b08c99a0d925e1a193bee8584d761d2d97a033cb0a522162e25"
size_bytes: 12075
git_status: clean
---
...
Install target: `~/.config/waybar/style.css`
...
* {
    border: none;
    border-radius: 0;
    font-family: "JetBrainsMono Nerd Font Propo","LXGW WenKai Screen","JetBrains Maple Mono","Font Awesome 7 Free";
...
#bluetooth {
    padding: 0px 0.3em 0 0.5em; /* 7px */
    font-size: 1.13em; /* 20px */

    
}
#bluetooth.disabled{
    padding: 0px 0.2em 0px 0.46em ;
}

#network {
    padding: 0px 0.35em 0 0.3em; /* 7px */
