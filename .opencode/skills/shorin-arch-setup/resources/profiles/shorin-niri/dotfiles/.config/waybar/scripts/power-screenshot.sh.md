---
source: dotfiles/.config/waybar/scripts/power-screenshot.sh
target: .config/waybar/scripts/power-screenshot.sh
type: text
language: bash
mode: "0755"
executable: true
...
# .config/waybar/scripts/power-screenshot.sh

Source: `dotfiles/.config/waybar/scripts/power-screenshot.sh`

Install target: `~/.config/waybar/scripts/power-screenshot.sh`
