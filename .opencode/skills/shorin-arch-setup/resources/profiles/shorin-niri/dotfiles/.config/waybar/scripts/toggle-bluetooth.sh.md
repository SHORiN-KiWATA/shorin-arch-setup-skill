---
source: dotfiles/.config/waybar/scripts/toggle-bluetooth.sh
target: .config/waybar/scripts/toggle-bluetooth.sh
type: text
language: bash
mode: "0755"
executable: true
...
Install target: `~/.config/waybar/scripts/toggle-bluetooth.sh`
