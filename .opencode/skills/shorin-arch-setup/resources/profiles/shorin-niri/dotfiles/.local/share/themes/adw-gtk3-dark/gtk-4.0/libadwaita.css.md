---
source: dotfiles/.local/share/themes/adw-gtk3-dark/gtk-4.0/libadwaita.css
target: .local/share/themes/adw-gtk3-dark/gtk-4.0/libadwaita.css
type: text
language: css
mode: "0644"
executable: false
...
owner_scope: user
backup: true
sha256: "5ed9ce7cf0d4be4ac68718c28ecc83eff1d5ac4d124836bc4a180a6d000b0d9e"
size_bytes: 355123
git_status: clean
---

# .local/share/themes/adw-gtk3-dark/gtk-4.0/libadwaita.css

Source: `dotfiles/.local/share/themes/adw-gtk3-dark/gtk-4.0/libadwaita.css`

Install target: `~/.local/share/themes/adw-gtk3-dark/gtk-4.0/libadwaita.css`
...
calendar.view:disabled, window.print:not(.ssd-frame) calendar.dialog-action-box:disabled { color: var(--view-fg-color); }
...
columnview.view:disabled, treeview.view:disabled, window.print:not(.ssd-frame) columnview.dialog-action-box:disabled, window.print:not(.ssd-frame) treeview.dialog-action-box:disabled { color: var(--view-fg-color); }
...
treeview.view:disabled, window.print:not(.ssd-frame) treeview.dialog-action-box:disabled { color: color-mix(in srgb, var(--view-fg-color) var(--disabled-opacity), transparent); }
...
windowcontrols > button > image { background-color: color-mix(in srgb, currentColor 10%, transparent); border-radius: 100%; padding: 4px; transition: background 200ms cubic-bezier(0.25, 0.46, 0.45, 0.94), box-shadow 200ms cubic-bezier(0.25, 0.46, 0.45, 0.94); }
...
.dimmed, scale > value, progressbar > text, row.property > box.header > box.title > .title, row.property.expander > box > list > row.header > box.header > box.title > .title, row.expander image.expander-row-arrow, row label.subtitle, .dim-label, spinbutton > text > placeholder, entry > text > placeholder, headerbar .subtitle, windowtitle .subtitle, label.separator { opacity: var(--dim-opacity); }
...
listview.view:disabled, window.print:not(.ssd-frame) listview.dialog-action-box:disabled, list.view:disabled, window.print:not(.ssd-frame) list.dialog-action-box:disabled { color: var(--view-fg-color); }
...
row.entry:disabled .dimmed, row.entry:disabled scale > value, row.entry:disabled progressbar > text, row.entry:disabled row.property > box.header > box.title > .title, row.entry:disabled row.property.expander > box > list > row.header > box.header > box.title > .title, row.entry:disabled row.expander image.expander-row-arrow, row.expander row.entry:disabled image.expander-row-arrow, row.entry:disabled spinbutton > text > placeholder, row.entry:disabled entry > text > placeholder, row.entry:disabled label.separator, row.entry:disabled .dim-label, row.entry:disabled .subtitle { opacity: 1; }
...
row.entry.error .dimmed, row.entry.error scale > value, row.entry.error progressbar > text, row.entry.error row.property > box.header > box.title > .title, row.entry.error row.property.expander > box > list > row.header > box.header > box.title > .title, row.entry.error row.expander image.expander-row-arrow, row.expander row.entry.error image.expander-row-arrow, row.entry.error spinbutton > text > placeholder, row.entry.error entry > text > placeholder, row.entry.error label.separator, row.entry.error .dim-label, row.entry.error .subtitle, row.spin.error .dimmed, row.spin.error scale > value, row.spin.error progressbar > text, row.spin.error row.property > box.header > box.title > .title, row.spin.error row.property.expander > box > list > row.header > box.header > box.title > .title, row.spin.error row.expander image.expander-row-arrow, row.expander row.spin.error image.expander-row-arrow, row.spin.error spinbutton > text > placeholder, row.spin.error entry > text > placeholder, row.spin.error label.separator, row.spin.error .dim-label, row.spin.error .subtitle { opacity: 1; }

row.entry.warning, row.spin.warning { color: var(--accent-color); }

row.entry.warning .dimmed, row.entry.warning scale > value, row.entry.warning progressbar > text, row.entry.warning row.property > box.header > box.title > .title, row.entry.warning row.property.expander > box > list > row.header > box.header > box.title > .title, row.entry.warning row.expander image.expander-row-arrow, row.expander row.entry.warning image.expander-row-arrow, row.entry.warning spinbutton > text > placeholder, row.entry.warning entry > text > placeholder, row.entry.warning label.separator, row.entry.warning .dim-label, row.entry.warning .subtitle, row.spin.warning .dimmed, row.spin.warning scale > value, row.spin.warning progressbar > text, row.spin.warning row.property > box.header > box.title > .title, row.spin.warning row.property.expander > box > list > row.header > box.header > box.title > .title, row.spin.warning row.expander image.expander-row-arrow, row.expander row.spin.warning image.expander-row-arrow, row.spin.warning spinbutton > text > placeholder, row.spin.warning entry > text > placeholder, row.spin.warning label.separator, row.spin.warning .dim-label, row.spin.warning .subtitle { opacity: 1; }

row.entry.success, row.spin.success { color: var(--accent-color); }

row.entry.success .dimmed, row.entry.success scale > value, row.entry.success progressbar > text, row.entry.success row.property > box.header > box.title > .title, row.entry.success row.property.expander > box > list > row.header > box.header > box.title > .title, row.entry.success row.expander image.expander-row-arrow, row.expander row.entry.success image.expander-row-arrow, row.entry.success spinbutton > text > placeholder, row.entry.success entry > text > placeholder, row.entry.success label.separator, row.entry.success .dim-label, row.entry.success .subtitle, row.spin.success .dimmed, row.spin.success scale > value, row.spin.success progressbar > text, row.spin.success row.property > box.header > box.title > .title, row.spin.success row.property.expander > box > list > row.header > box.header > box.title > .title, row.spin.success row.expander image.expander-row-arrow, row.expander row.spin.success image.expander-row-arrow, row.spin.success spinbutton > text > placeholder, row.spin.success entry > text > placeholder, row.spin.success label.separator, row.spin.success .dim-label, row.spin.success .subtitle { opacity: 1; }
...
/***************** Property rows * */
row.property > box.header > box.title > .title, row.property.expander > box > list > row.header > box.header > box.title > .title { font-size: smaller; }

row.property > box.header > box.title > .subtitle, row.property.expander > box > list > row.header > box.header > box.title > .subtitle { font-size: inherit; opacity: 1; }

row.property.monospace, row.property.monospace.expander > box > list > row.header { font-family: inherit; font-size: inherit; }

row.property.monospace > box.header > box.title > .subtitle, row.property.monospace.expander > box > list > row.header > box.header > box.title > .subtitle { font-family: var(--monospace-font-family); font-size: var(--monospace-font-size); }
...
.view:disabled, window.print:not(.ssd-frame) .dialog-action-box:disabled, textview > text:disabled, dialog-host > dialog.view sheet:disabled, window.print:not(.ssd-frame) dialog-host > dialog.dialog-action-box sheet:disabled, iconview:disabled { color: color-mix(in srgb, var(--view-fg-color) var(--disabled-opacity), transparent); background-color: color-mix(in srgb, var(--window-bg-color) 60%, var(--view-bg-color)); }
...
flowbox.view:disabled, window.print:not(.ssd-frame) flowbox.dialog-action-box:disabled, gridview.view:disabled, window.print:not(.ssd-frame) gridview.dialog-action-box:disabled { color: var(--view-fg-color); }
