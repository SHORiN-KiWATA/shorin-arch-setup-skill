---
source: resources/必看-Shorin-Noctalia-Niri使用方法.txt
type: source-resource
language: text
mode: "0644"
sha256: "57171f251b8df9112135ead07401ea960c30c2e00720c477bb391a5fca81eb8a"
size_bytes: 4862
---

# resources/必看-Shorin-Noctalia-Niri使用方法.txt

~~~~text
可以查阅的文档：
ArchWiki: https://wiki.archlinux.org/title/Main_page
NoctaliaWiki: https://noctalia.dev/
...
【必要设置】
1.更换壁纸
Mod+Alt+W打开壁纸切换器，切换一次壁纸，此时会自动生成所有的主题颜色。
如果要取消开启时随机更换壁纸的功能可以编辑~/.config/niri/config.kdl，删除自动切换壁纸的spawn-sh-at-stratup。
...
【显示器设置】
需要编辑~/.config/niri/blur.kdl。

【窗口背景模糊（blur）】
blur相关的设置在~/.config/niri/windowrule.kdl，有需要可以自行调整。
...
【详细按键教程】
所有的键位都可以在.config/niri/binds.kdl里找到
